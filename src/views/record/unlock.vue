<template>
  <div class="app-container">
    <div class="filter-container" style="margin-top: 20px">
      ...
      <div class="filter-right">
        <el-date-picker
          ...
          type="datetimerange"
          range-separator="至"
          start-placeholder="解锁时间开始"
          end-placeholder="解锁时间结束"
    ...
    >
      ...
      <el-table-column label="锁仓数量/AFT" align="right" prop="total_locked">
        <template slot-scope="scope">
          {{scope.row.total_locked|noDataFilter}}
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    exportRecord() {
      ...
      location.href = window.$constant.BASE_URL + '/api/back/export-unlock-record?start_time=' + startTime +
        '&end_time=' + endTime +
